   ...
   handleTime = (text) => {
    ...
    login = (taskTitle, taskDesc, date) => {
      if(taskTitle == "" && taskDesc == "" && date == ""){
        ...
        this.setState({date:''})
        let taskTitleVal = this.refs["taskTitle"]
        taskTitleVal.clear();
        let taskDescVal = this.refs["taskDesc"]
        taskDescVal.clear();
        let dateVal = this.refs["date"]
        dateVal.clear();
      ...
      return (
         <View style = {styles.container}>
            ...
            <TouchableOpacity
               ...
               onPress = {
                  () => this.login(this.state.taskTitle, this.state.taskDesc,this.state.date)
               }>
